 ...
 * @author antho
 */
public class registro_almacen extends javax.swing.JFrame {

    /**
     * Creates new form registro_almacen
     */
    public registro_almacen() {
        initComponents();
    }
    ...
    public almacen atrapar_datos(){
        ...
        else if(en_marca.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Campo marca vacio", "Error",JOptionPane.WARNING_MESSAGE);
        }
        else if(en_precio.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Campo precio vacio", "Error",JOptionPane.WARNING_MESSAGE);
        }
        else if(en_cantidad.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Campo cantidad vacio", "Error",JOptionPane.WARNING_MESSAGE);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(boton_registrar, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(en_nombre, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(en_marca, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(en_precio, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(en_cantidad, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(categoria_selec, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void boton_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_registrarActionPerformed
        ...
        String centenciasql = String.format("INSERT INTO almacen(id,nombre,marca,categoria,precio,cantidad)" +
             "VALUES (null,'%s','%s','%s',%d,%d)",nproducto.getNombre(),nproducto.getMarca(),nproducto.getCategoria(),nproducto.getPrecio(),nproducto.getCantidad());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registro_almacen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registro_almacen().setVisible(true);
            }
        });
    }
